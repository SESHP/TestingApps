...
function Guarantee() {
  ...
  const HourglassAnimation = () => {
    ...
    useEffect(() => {
      ...
      // Встроенная Lottie анимация песочных часов с переливанием песка
      const hourglassAnimationData = {
        "v": "5.9.0",
        "fr": 60,
        "ip": 0,
        "op": 240,
            ...
            "ks": {
              ...
              "r": {
                ...
                "k": [
                  ...
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 100, "s": [0] },
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 110, "s": [180] },
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 220, "s": [180] },
                  { "t": 230, "s": [360] }
                ]
              },
              "p": { "a": 0, "k": [200, 200, 0] },
            ...
            "shapes": [
              {
                "ty": "gr",
                "it": [
                  { "ty": "el", "s": { "a": 0, "k": [140, 140] }, "p": { "a": 0, "k": [0, -80] } },
                  { "ty": "st", "c": { "a": 0, "k": [0.95, 0.49, 0, 1] }, "o": { "a": 0, "k": 100 }, "w": { "a": 0, "k": 6 } },
                  { "ty": "fl", "c": { "a": 0, "k": [0.1, 0.1, 0.1, 0.05] }, "o": { "a": 0, "k": 100 } },
              ...
              },
              {
                "ty": "gr",
                "it": [
                  { "ty": "rc", "d": 1, "s": { "a": 0, "k": [50, 180] }, "p": { "a": 0, "k": [0, 0] }, "r": { "a": 0, "k": 0 } },
                  { "ty": "st", "c": { "a": 0, "k": [0.95, 0.49, 0, 1] }, "o": { "a": 0, "k": 100 }, "w": { "a": 0, "k": 6 } },
                  { "ty": "tr", "p": { "a": 0, "k": [-45, 0] }, "a": { "a": 0, "k": [0, 0] }, "s": { "a": 0, "k": [100, 100] }, "r": { "a": 0, "k": 0 }, "o": { "a": 0, "k": 100 } }
                ]
              },
              {
                "ty": "gr",
            ...
            "ks": {
              "o": {
                ...
                "k": [
                  ...
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 100, "s": [0] },
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 110, "s": [0] },
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 120, "s": [100] },
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 220, "s": [0] },
                  { "t": 230, "s": [0] }
                ]
              },
              "r": {
            ...
            "shapes": [
              {
                "ty": "gr",
                "it": [
                  { "ty": "el", "s": { "a": 0, "k": [100, 100] }, "p": { "a": 0, "k": [0, -80] } },
                  { "ty": "fl", "c": { "a": 0, "k": [1, 0.76, 0.4, 1] }, "o": { "a": 0, "k": 100 } },
                  { "ty": "tr", "p": { "a": 0, "k": [0, 0] }, "a": { "a": 0, "k": [0, 0] }, "s": { "a": 0, "k": [100, 100] }, "r": { "a": 0, "k": 0 }, "o": { "a": 0, "k": 100 } }
                ]
              }
            ],
          ...
          },
          {
            ...
            "ks": {
              "o": {
                ...
                "k": [
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 0, "s": [0] },
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 100, "s": [100] },
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 110, "s": [100] },
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 120, "s": [0] },
                  { "i": { "x": [0.42], "y": [1] }, "o": { "x": [0.58], "y": [0] }, "t": 220, "s": [100] },
                  { "t": 230, "s": [100] }
                ]
              },
              "r": {
